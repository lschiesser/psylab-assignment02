...
author: "Paribartan Humagain, Lukas Schiesser"
output:
  html_document
---
...
*ANSWER: R version 3.5.1 (2018-07-02), Windows*
...
*ANSWER: The variable "supp" is a Factor.*
...
# YOUR CODE HERE
tooth_growth_tibble <- ToothGrowth %>% 
  group_by(supp) %>% 
...
# YOUR CODE HERE
ggplot(iris_tibble, aes(x = dose, y = len)) +
...
*ANSWER: For the doses of 0.5 and 1.0 mg there seems to be a difference in favor of orange juice, but for 2.0 mg dosage there is a difference in favor of ascorbic acid. All in all, involving the mean when inspecting the graph, orange juice seems to enhance the length of odontoblasts in guinea pigs.*
