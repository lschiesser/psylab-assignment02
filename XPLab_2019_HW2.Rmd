...
# YOUR CODE HERE
filter(ToothGrowth, supp == "OJ" & dose>= 1.0)
...
# YOUR CODE HERE
tooth_growth_tibble <- ToothGrowth %>% group_by(supp) %>% summarise(mean_len = mean(len))
